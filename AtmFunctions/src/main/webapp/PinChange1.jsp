...
.buttons{
    position: absolute;left: 650px;top:150px;
      height: 350px;
      width: 250px;
      border-radius: 8px;
...
#okbtn{
    position: absolute;top:200px;left:1250px;
    height: 50px;
    width: 80px;
    cursor:pointer;
...
<body>
        ...
        <div class="content2">Enter New Pin</div>
        
        <form  action="PinChangeServlet1" method="post">
        <div id="inputbox2"><input type="text" id="input" name="newpin"></div>
